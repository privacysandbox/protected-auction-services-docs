...
<table>
  ...
  <tr>
    <td><code>sellerReportingSignals</code></td>
...
<tr>
    <td><code>buyerReportingSignals</code></td>
...
- `buyerReportingSignals` additionally contains all the signals present in the
...
- The SellerFrontEnd service sends the required signals to run `reportResult()`
